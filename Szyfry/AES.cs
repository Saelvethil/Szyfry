...
namespace Szyfry
{
    public class AES 
    {
        ...
        public  byte[] Encrypt128Bit(byte[] block)
        {
            AddRoundKey(block, 0);
        ...
        public  byte[] Decrypt128Bit(byte[] block)
        {
            AddRoundKey(block, Nr);
            //Nr=10,12 or 14 depending on key size
